...
use super::{
    common,
    common::{
        Order, OrderInputParams, OrderInputParamsSimple, Payment, FEE_PENALTY_INCREASE_PERCENT, MAX_ORDERS_PER_USER,
        PERCENT_BASE_POINTS,
    },
};
...
pub trait ValidationModule: common::CommonModule {
    ...
    fn require_valid_order_input_params(&self, params: &OrderInputParamsSimple<Self::Api>) {
