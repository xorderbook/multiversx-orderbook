...
export const Header = () => {
  ...
  return (
    <header className='flex flex-row  xl:max-w-[1280px] w-full mx-auto  align-center justify-between   py-2 bg-[#171717] items-center '>
      <MxLink
        className='flex items-center justify-between  '
        to={RouteNamesEnum.home}
      >
        <img className='h-[2.35rem] pr-2' src={logo} alt='logo' />
